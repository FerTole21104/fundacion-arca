...
if ( ! function_exists( 'chinchilla_about_after_switch_theme' ) ) {
	...
	/**
	 * Update option 'chinchilla_about_page' after switch a theme to redirect to the page 'About Theme' on next page load.
	 *
	 * Hooks: add_action( 'after_switch_theme', 'chinchilla_about_after_switch_theme', 1000 );
	 */
...
if ( ! function_exists( 'chinchilla_about_after_setup_theme' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'init', 'chinchilla_about_after_setup_theme', 1000 );
	 */
...
if ( ! function_exists( 'chinchilla_about_add_menu_items' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'admin_menu', 'chinchilla_about_add_menu_items' );
	 */
...
if ( ! function_exists( 'chinchilla_about_enqueue_scripts' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'admin_enqueue_scripts', 'chinchilla_about_enqueue_scripts' );
	 */
